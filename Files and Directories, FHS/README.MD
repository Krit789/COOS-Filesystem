...
เป็นการสร้างช่องทางให้เข้าถึงไฟล์ได้อีกทาง โดยทั้งตัวที่สร้างใหม่ กับตัวไฟล์เดิมจะถือเป็นไฟล์เดียวกัน โดยระหว่างที่ regular file นั้นมีแค่ชื่อเดียว แต่ hard link ทำให้เราสามารถสร้างชื่อที่ชื้ไปยังข้อมูลตัวเดียวกันได้ใน disk เหมือนกับการสร้าง shortcut ไปยังไฟล์เดียวกันโดยไม่ได้คัดลอกเนื้อหาไฟล์ 
