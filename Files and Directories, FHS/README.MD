...
directory นี้ประกอบไปด้วย subdirectory ที่จะเป็นจุดเชื่อมต่อระบบไฟล์ของอุปกรณ์สื่อบันทึกที่สามารถถอดออกได้ เช่นพวก แผ่นดิสก์, ซีดีรอม เป็นต้น
...
* /usr/tmp <br> เก็บไฟล์ชั่วคราวของ user แต่ในรุ่นใหม่ๆ ไม่พบการใช้งานเลย ซึ่งตัวอี้อาจจะได้รับผลมาจาก UNIX
