...
ถ้าหากเครื่องเกิดการ crash หรือเครื่องดับ อาจเกิดจากสาเหตุอะไรก็ตาม เมื่อสามารถ boot กลับมาได้จะมีการตรวจสอบระบบไฟล์โดยคำสั่ง fsck โดย fsck จะทำการตรวจสอบระบบทั้งหมดและพยายามกู้คืนไฟล์ที่เสียหายหากพบเจอ ซึ่งผลของการกู้นี้จะมาอยู่ใน /lost+found นี้นั้นเอง
