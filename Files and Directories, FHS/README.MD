...
เช่นเดียวกับ[`Local domain sockets`](#Local_domain_sockets) pipe ที่มีชื่ออนุญาตให้มีการสื่อสารระหว่างมืออาชีพสองคน
เซสชั่นทำงานบนโฮสต์เดียวกัน เรียกอีกอย่างว่า “ไฟล์ FIFO” (ในด้านการเงิน
การบัญชี FIFO ย่อมาจากวลี “เข้าก่อน ออกก่อน”) คุณสามารถสร้างชื่อ
ไปป์ด้วย mknod และลบออกด้วย rm
  ไปป์ที่มีชื่อและซ็อกเก็ตโดเมนท้องถิ่นมีจุดประสงค์ที่คล้ายกันและความจริงที่ว่า
ทั้งสองมีอยู่จริงโดยพื้นฐานแล้วเป็นสิ่งประดิษฐ์ทางประวัติศาสตร์ เป็นไปได้มากว่าทั้งสองจะไม่มีอยู่จริง
หาก UNIX และ Linux ได้รับการออกแบบในปัจจุบัน ซ็อกเก็ตเครือข่ายจะรองรับทั้งสองอย่าง
